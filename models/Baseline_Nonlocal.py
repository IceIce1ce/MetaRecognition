...
from .non_local_attention import NONLocalBlock3D

class Baseline_Nonlocal(nn.Module):
    def __init__(self, num_classes, pretrained=None):
        super(Baseline_Nonlocal, self).__init__()
        ...
        self.nl1 = NONLocalBlock3D(in_channels=128)
        # Layer 3
        self.conv3a = nn.Conv3d(128, 256, kernel_size=(3, 3, 3), padding=(1, 1, 1))
        self.conv3b = nn.Conv3d(256, 256, kernel_size=(3, 3, 3), padding=(1, 1, 1))
        self.pool3 = nn.MaxPool3d(kernel_size=(2, 2, 2), stride=(2, 2, 2))
        self.nl2 = NONLocalBlock3D(in_channels=256)
        # Layer 4
        self.conv4a = nn.Conv3d(256, 512, kernel_size=(3, 3, 3), padding=(1, 1, 1))
        self.conv4b = nn.Conv3d(512, 512, kernel_size=(3, 3, 3), padding=(1, 1, 1))
        self.pool4 = nn.MaxPool3d(kernel_size=(2, 2, 2), stride=(2, 2, 2))
        self.nl3 = NONLocalBlock3D(in_channels=512)
        # Layer 5
...
if __name__ == "__main__":
    ...
    model = Baseline_Nonlocal(num_classes=101)
    # print(model)
