# https://github.com/MRzzm/action-recognition-models-pytorch/blob/master/3DCNN/S3D/Fast_S3D.py
import torch
...
class Inception_block(nn.Module):
    def __init__(self, in_channel, out_channel):
        ...
        self.branch4 = nn.Sequential(nn.MaxPool3d(kernel_size=(1, 3, 3), stride=1, padding=(0, 1, 1)),
...
if __name__ == "__main__":
    ...
    model = Fast_S3D(num_classes=101)
    print(model)
