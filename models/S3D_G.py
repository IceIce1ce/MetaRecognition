# https://github.com/MRzzm/action-recognition-models-pytorch/blob/master/3DCNN/S3D/S3D_G.py
# use pytorch 1.7.0 for this model to avoid error conv1D
import torch
...
class S3D_G_block(nn.Module):
    def __init__(self,in_channel,out_channel):
        ...
        self.excitation = nn.Conv1d(1, 1, (3, 1, 1), stride=1, padding=(1, 0, 0)) # replace weight matrix with 1D conv to reduce the params
...
class S3D_G(nn.Module):
    def __init__(self, num_classes):
        ...
        self.avg_pool = nn.AvgPool3d(kernel_size=(2, 3, 3)) # change to (8, 7, 7) for input (1, 3, 64, 224, 224)
